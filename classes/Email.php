...
class Email{
    ...
    public function sendConfirmacion(){
        $mail = new PHPMailer();
        $mail->isSMTP();
        $mail->Host = 'sandbox.smtp.mailtrap.io';
        $mail->SMTPAuth = true;
        $mail->Port = 2525;
        $mail->Username = '2d7c18a5af0226';
        $mail->Password = '48db0aff4cff1c';
    ...
    public function sendInstrucciones(){
        $mail = new PHPMailer();
        $mail->isSMTP();
        $mail->Host = 'sandbox.smtp.mailtrap.io';
        $mail->SMTPAuth = true;
        ...
        $contenido = "<html>";
        $contenido .= "<p> <strong>Hola ". $this->nombre ."</strong> para reestablecer tu contraseña, solo debes presionar el siguiente enlace</p>";
